      ...
      <Container style={{ padding: 'clamp(44px, 6vw, 80px) var(--container-pad) clamp(40px, 5vw, 64px)' }}>
        <div style={{
          ...
          <div>
            ...
            }}>Professionelle Fotos und Videos für Maklerbüros. Hochwertiger Content, der Ihre Objekte schneller vermittelt, qualifiziertere Anfragen bringt und Ihr Büro als Marke sichtbar macht.
            ...
            <p style={{
              ...
              margin: '20px 0 0', lineHeight: 1.6, fontWeight: "700"
            }}>
