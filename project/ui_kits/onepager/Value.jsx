...
function Benefits() {
  const { Card } = window.MaklerContentDesignSystem_a211b6;
...
function Segments() {
  const { Card, Badge, MediaFrame } = window.MaklerContentDesignSystem_a211b6;
  const { Icon, Container, SectionHead } = window;
...
Object.assign(window, { Benefits, Segments });
