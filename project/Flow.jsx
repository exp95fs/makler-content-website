    ...
    <Section bg="page">
      <Container>
        <div style={{
          ...
          }}>Wir sind neu am Markt im Raum Bühl, Mittelbaden, Ortenau und wir bauen unser Referenz-Portfolio auf. Statt Versprechen zu machen, zeigen wir Ihnen lieber das Ergebnis an einem Ihrer Objekte.
          ...
          <div style={{ marginTop: '28px' }}>
            <Button variant="primary" size="lg" iconRight={<Icon name="arrow-right" size={18} />} onClick={() => onNav('anfrage')}>Pilotplatz sichern
      ...
      <Container>
        <div style={{
          ...
          <div>
            ...
            }}>Fabian — Foto, Video & strategischer Blick in einer Person.
            ...
            }}>Ich habe viele Jahre Foto- und Videoprojekte für namhafte Unternehmen umgesetzt. Mein Schwerpunkt: visuelle Botschaften so zu planen und zu produzieren, dass sie nicht nur hochwertig aussehen, sondern bei der richtigen Zielgruppe Wirkung erzielen.

Heute nutze ich diese Erfahrung für Maklerbüros, Immobilien und Ferienobjekte. Mit Fotos, Videos und Markencontent, die Objekte besser präsentieren, Vertrauen schaffen und Ihrem Auftritt eine klare visuelle Identität geben.

Aus Bühl für Mittelbaden, die Ortenau und Umgebung.</p>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', lineHeight: 'var(--lh-normal)',
