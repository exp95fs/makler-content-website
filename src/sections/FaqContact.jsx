...
export function Faq() {
  const items = [
    ...
    { q: 'Was kostet die Produktion?', a: 'Eine Einzelproduktion liegt je nach Umfang bei 350–1.290 € netto: Foto-Pakete ab 350 €, Videoproduktionen ab 890 €, dazu optionale Zusatzleistungen wie Drohne oder Home Staging. Bei zwei Objekten am selben Termin sparen Sie 10 % auf den Gesamtpreis. Ihr genauer Preis wird in der Terminanfrage berechnet.' },
